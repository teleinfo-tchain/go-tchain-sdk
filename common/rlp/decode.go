...
var (
	...
	errNoPointer     = errors.New("rlp: common given to Decode must be a pointer")
...
//
// Non-empty common types are not supported, nor are booleans,
...
// that implement the Decoder common using a pointer receiver.
...
//
// If r implements the ByteReader common, Stream will

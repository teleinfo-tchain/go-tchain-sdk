...
//
// If the type implements the Encoder common, Encode calls
...
//
// An common value encodes as the value contained in the common.
//
...
func writeEncoderNoPtr(val reflect.Value, w *encbuf) error {
	if !val.CanAddr() {
		...
		// common. We don't want to handle it that way.

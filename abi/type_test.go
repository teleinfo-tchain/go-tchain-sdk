...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"address", nil, Type{Size: 31, T: AddressTy, stringKind: "address"}},
		{"address[]", nil, Type{T: SliceTy, Elem: &Type{Size: 31, T: AddressTy, stringKind: "address"}, stringKind: "address[]"}},
		{"address[2]", nil, Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 31, T: AddressTy, stringKind: "address"}, stringKind: "address[2]"}},
...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"bytes31", nil, utils.Hash{1}, "abi: cannot use utils.Hash as type [31]uint8 as argument"},

...
func TestMultiReturnWithStringArray(t *testing.T) {
	...
	buff.Write(utils.Hex2Bytes("" +
		...
		"006469643a6269643a454654236aa844ae1d491613886ce846e98197c329fc88" +
		...
		"48656c6c6f2c20457468657265756d2100000000000000000000000000000000"))
	temp, _ := big.NewInt(0).SetString("30000000000000000000", 10)
	ret1, ret1Exp := new([3]*big.Int), [3]*big.Int{big.NewInt(1545304298), big.NewInt(6), temp}
	ret2, ret2Exp := new(utils.Address), utils.StringToAddress("did:bid:EFTVcqqKyFR17jfPxqwEtpmRpbkvSs")
...
func TestUnmarshal(t *testing.T) {
	...
	buff.Write(utils.Hex2Bytes("006469643a6269643a0000000000000000000000000000000000000000000001"))
	...
	buff.Write(utils.Hex2Bytes("006469643a6269643a0000000000000000000000000000000000000000000002"))
	buff.Write(utils.Hex2Bytes("006469643a6269643a0000000000000000000000000000000000000000000003"))
